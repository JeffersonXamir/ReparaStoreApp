...
namespace ReparaStoreApp.Data.Migrations
{
    ...
    [Migration("20250709140632_DefinicionTablasParaTienda")]
    partial class DefinicionTablasParaTienda
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReparaStoreApp.Entities.Models.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "001",
                            CreatedAt = new DateTime(2025, 7, 9, 14, 6, 32, 427, DateTimeKind.Utc).AddTicks(6665),
                            ...
                            PasswordHash = "$2a$11$yMIOkYUtDFFn3oIgez89UuN/L3DDZC5aheS5OKSb5XN1FoKC4dbTm",
